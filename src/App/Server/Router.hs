...
import App.Infrastructure.Repository.Habit.HabitSQLServer (runHabitRepo)
import App.Infrastructure.Repository.Record.RecordSQLite (runRecordRepo)
...
import App.Presentation.HabitTracker.Handler (HabitRunner, getHabitsAllHandler, postHabitHandler)
        ...
        cors (const $ Just corsPolicy) $
          serveWithContext
            ...
            ( loginHandler sqlserverPool redisConn
                ...
                :<|> (getHabitsAllHandler mkHabitRunner :<|> postHabitHandler mkHabitRunner)
            )
